...
* Pour répondre à « Quels problèmes continuent de revenir ? » — Aperçu des Réunions identifie les thèmes récurrents dans les réunions SIM sur une période choisie.
...
* Au moins une transcription de réunion produite par Analyse de Réunion doit exister dans l'environnement DISS.
...
{% hint style="info" %}
* La qualité des insights dépend de la qualité des comptes-rendus Analyse de Réunion sous-jacents : encourager des enregistrements clairs et la mention explicite des responsables et des dates lors des réunions.
...
* La participation IA en temps réel pendant la réunion SIM elle-même ne fait pas partie de cette version : Aperçu des Réunions opère aujourd'hui sur des comptes-rendus déjà enregistrés.
